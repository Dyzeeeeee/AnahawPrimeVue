  ...
  const updateLineData = (orders) => {
    ...
    lineData.datasets[0].data = ordersPerMonth;
  };
  ...
  <template>
    <div class="grid">
        ...
        <div class="card mb-0">
          <div class="flex justify-content-between mb-3">
            <div>
              ...
              <div class="text-900 font-medium text-xl">{{ totalCustomers }}</div>
            </div>
      ...
      <div class="col-12 xl:col-6">
        <div class="card">
          <h5>Recent Sales</h5>
          <DataTable :value="orders" dataKey="id" :rows="5" v-model:expandedRows="expandedRows" :paginator="true"
            responsiveLayout="scroll" v-model:selection="selectedOrder" stripedRows>

            <Column expander style="width: 4rem" />
            <!-- <Column field="id" header="ID">
            </Column> -->

            <Column field="cashier_name" header="Cashier" style="width: 5rem">
            </Column>
            ...
            <template #expansion="slotProps">
              <div class="px-5 mx-5">
                ...
                <DataTable :value="slotProps.data.details" selectionMode="multiple">
                  <Column field="menu_item_name" header="Menu Item"></Column>
